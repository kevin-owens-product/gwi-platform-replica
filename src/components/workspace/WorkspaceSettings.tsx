...
import { useTeamWorkspace, useUpdateTeamWorkspace } from '@/hooks/useTeams'
...
export default function WorkspaceSettings({ teamId }: WorkspaceSettingsProps) {
  ...
  if (!workspace) return <div className="ws-settings__empty">No workspace configured for this team.</div>
  ...
  return (
    <div className="ws-settings">
      <div className="ws-settings__header">
        <div>
          <h3 className="ws-settings__title">Workspace Context</h3>
          <p className="ws-settings__subtitle">
            Define business context and defaults for this team. This context is used across all tools including Agent Spark.
          </p>
        </div>
        {!isEditing ? (
      ...
      {/* Brands & Competitors */}
      <div className="ws-settings__section-row">
        <div className="ws-settings__section ws-settings__section--half">
          <h4><Building2 size={16} /> Brands</h4>
          <TagList items={ctx.brand_names} field="brand_names" editable={isEditing} />
        </div>
        <div className="ws-settings__section ws-settings__section--half">
          <h4><Building2 size={16} /> Competitors</h4>
      ...
      <div className="ws-settings__section">
        ...
        {isEditing ? (
          ...
          <p className="ws-settings__notes">{ctx.notes || 'No notes added.'}</p>
        )}
      </div>
      ...
      <div className="ws-settings__section">
        <h4>Defaults</h4>
        <div className="ws-settings__defaults">
          <div className="ws-settings__default-item">
            <span className="ws-settings__default-label">Datasets</span>
            <div className="ws-settings__tags">
              {ctx.allowed_datasets.map((ds) => (
                <Badge key={ds} variant="default">{ds}</Badge>
              ))}
            </div>
          </div>
        </div>
