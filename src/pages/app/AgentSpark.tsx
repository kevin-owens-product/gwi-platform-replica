      ...
      <div className="chat-container">
        ...
        <div className="agentic-panel">
          <div className="agentic-section">
            <div className="agentic-section-title">Run Flow</div>
            <div className="agentic-section-subtitle">
              Execute an orchestrated flow with your brief. Results appear in Recent Runs.
            </div>
          ...
          <div className="agentic-section">
            <div className="agentic-section-title">Execution Blueprint</div>
            <div className="agentic-section-subtitle">
              Read-only preview of the exact steps the selected flow will execute.
            </div>
            {selectedFlow ? (
          ...
          {activeAgent && (
            <div className="agentic-section">
              <div className="agentic-section-title">Agent Examples (Optional)</div>
              <div className="agentic-section-subtitle">
                Prompt ideas for {activeAgent.name}. These help draft chat inputs and do not change the selected flow.
              </div>
              <div className="agentic-demo-summary">{activeAgent.demo.workflowName}</div>

              <div className="agentic-demo-group-title">Try a prompt</div>
